...
class archer(boardElements):
    ...
    def moveandkill(self , all_huts , background , hall , king):
        ...
        if (self.inpos==1 and self.freq%10==0):
                for i in range(6):   
                    print(all_huts[i].health , end=" ")
                    if (target ==1 and abs(73 - self.y)<8) :
